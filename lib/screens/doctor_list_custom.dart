import 'package:doctor_app/controllers/doctorlistController.dart';
...
class DoctorListWidget extends GetWidget<DoctorListController> {
  Specialist? currentSpecialist;

  DoctorListWidget({this.currentSpecialist});

  TextEditingController searchTextController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    return GetX<DoctorListController>(
        builder: (controller) => Scaffold(
              body: Column(children: [
                _searchWidget(context),
                SizedBox(height: 10),
                _typesOfSpecialist(context, controller),
                SizedBox(height: 10),
                _doctorListWidget(context, controller)
              ]),
            ));
  }
  ...
  //type of specialists
  Widget _typesOfSpecialist(
      BuildContext context, DoctorListController controller) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return index == 0
              ? _typeAllForSpecialist(controller)
  ...
  //all specialists
  Widget _typeAllForSpecialist(DoctorListController controller) {
    bool selected = (currentSpecialist == null);

    return GestureDetector(
      onTap: () {
        // setState(() {
        currentSpecialist = null;
        controller.getDoctorList(null);
  ...
  Widget _eachTypeOfSpecialist(BuildContext context, Specialist specialist) {
    bool selected = false;
    if (specialist != null)
      selected = (specialist.name == currentSpecialist!.name);
  ...
  Widget _doctorListWidget(
    ...
    return Padding(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return _doctorItemWidget(context, controller.doctorList[index]);
          }),
    );
  }
